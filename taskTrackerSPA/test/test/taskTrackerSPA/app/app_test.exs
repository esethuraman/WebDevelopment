defmodule TaskTrackerSPA.AppTest do
  ...
  describe "tasks" do
    ...
    @valid_attrs %{assigned_to: "some assigned_to", body: "some body", completed: true, description: "some description", minutes_worked: 42, name: "some name"}
