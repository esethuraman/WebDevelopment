...
function createNewTimeBlock(todo_id) {
  ...
  _jquery2.default.ajax(timer_path, {
    method: "post",
    dataType: "json",
...
function updateStartTime(todo_id, timer_id, end_time) {
  ...
  _jquery2.default.ajax(timer_path + "/" + timer_id, {
    method: "put",
    dataType: "json",
    contentType: "application/json; charset=UTF-8",
    data: text,
...
function onUpdateStartTimeClick(ev) {
  var btn = (0, _jquery2.default)(ev.target);
  var todo_id = btn.data('todo-id');
  var timer_id = btn.data('timer-id');
  var end_time = btn.data('end-time');
...
function onUpdateEndTimeClick(ev) {
  ...
  var todo_id = btn.data('todo-id');
  var timer_id = btn.data('timer-id');
  var start_time = btn.data('start-time');
...
function init() {
  ...
  (0, _jquery2.default)('.newtimeblock').click(onNewTimeBlockClick);
  (0, _jquery2.default)('.updateStartTime').click(onUpdateStartTimeClick);
  (0, _jquery2.default)('.updateEndTime').click(onUpdateEndTimeClick);
  console.log("Hello1");
  (0, _jquery2.default)('.deleteTimeBlock').click(onDeleteClick);
}
